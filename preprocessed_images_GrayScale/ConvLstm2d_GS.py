...
model.add(tf.keras.layers.Conv2D(filters = 4, kernel_size = 3, input_shape=[150, 50, 50, 1], padding="same"))
...
history = model.fit(X_train, y_train, epochs=300, batch_size = 80, shuffle = True, validation_data=(X_valid, y_valid), callbacks=[callback])
...
#model.save('C:/Users/CASALAB/Desktop/Gruppo_20_Favb/Modelli/tentativo#')
